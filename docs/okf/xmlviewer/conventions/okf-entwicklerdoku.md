...
Klasse/Methode, aber keine Semantik. Das OKF-Bundle unter `docs/okf/xmlviewer/` ist die
...
- **Querverweise** immer bundle-root-absolut: `[XmlViewer](/components/xmlviewer.md)`
  (beginnt mit `/`, relativ zur Bundle-Wurzel `docs/okf/xmlviewer/`) — **nicht**
...
5. `docs/okf/xmlviewer/log.md` einen Eintrag unter dem heutigen ISO-Datum hinzufügen
